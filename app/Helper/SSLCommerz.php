...
class SSLCommerz
{
    public static function initiatePayment($user, $payable, $transactionId, $userEmail): array
    {
        try {
    ...
    public static function initiateSuccess($transactionId)
    {
    ...
    public static function initiateCancel($transactionId)
    {
    ...
    public static function initiateFailed($transactionId)
    {
    ...
    public static function initiateIPN($transactionId, $status, $validationId)
    {
