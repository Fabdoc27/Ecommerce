        ...
        <div class="col-md-12">
            <ul class="nav nav-tabs" id="myTab" role="tablist">
                ...
                <li class="nav-item" role="presentation">
                    <button class="nav-link active" id="review-tab" data-bs-toggle="tab" data-bs-target="#review-tab-pane"
            ...
            <div class="tab-content" id="myTabContent">
                ...
                <div class="tab-pane fade" id="review_create-tab-pane" role="tabpanel"
                    ...
                    <input min="10" value="10" max="100" step="5" id="reviewScore" type="number"
