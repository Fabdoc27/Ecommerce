        ...
        <div class="col-12">
            <div class="tab-style1">
                <ul class="nav nav-tabs justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="special-tab" data-bs-toggle="tab" href="#Trending" role="tab"
                            aria-controls="special" aria-selected="false">Discount</a>
                    </li>
                </ul>
            </div>
            <div class="tab-content">
                ...
                <div class="tab-pane fade" id="Discount" role="tabpanel" aria-labelledby="special-tab">
...
<script>
    async function Popular() {
        let res = await axios.get("/product-remark/popular");
        $("#PopularItem").empty();
                                ...
                                <div class="product_img">
                                    ...
                                    <div class="product_action_box">
                                        <ul class="list_none pr_action_btn">
                                            <li>
                                                <a href="/product?id=${item['id']}" class="popup-ajax"><i class="icon-magnifier-add"></i></a>
                                            </li>
                                        </ul>
                                    </div>
                                </div>
    ...
    async function New() {
        let res = await axios.get("/product-remark/new");
        $("#NewItem").empty();
    ...
    async function Top() {
        let res = await axios.get("/product-remark/top");
        $("#TopItem").empty();
    ...
    async function Special() {
        let res = await axios.get("/product-remark/special");
        $("#SpecialItem").empty();
    ...
    async function Trending() {
        let res = await axios.get("/product-remark/trending");
        $("#TrendingItem").empty();
    ...
    async function Discount() {
        let res = await axios.get("/product-remark/discount");
        $("#DiscountItem").empty();
